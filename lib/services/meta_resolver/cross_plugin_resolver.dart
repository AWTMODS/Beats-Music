...
final RegExp _kNoiseWords = RegExp(
    r'\b(?:official|video|music|lyrics?|audio|full|song|lyrical|hq|hifi|4k|hd|p)\b',
    caseSensitive: false);
...
class CrossPluginResolver {
  ...
  String simplifyTitle(String? value) {
    ...
    return value
        ...
        .replaceAll(_kNoiseWords, ' ') // Strip noise (Official, Video, etc.)
        .replaceAll(_kAsciiPunct, ' ')
        .replaceAll('&', ' and ')
        .replaceAll(_kMultiSpace, ' ')
        .trim();
