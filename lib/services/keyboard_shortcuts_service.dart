...
class _KeyboardShortcutsHandlerState extends State<KeyboardShortcutsHandler> {
  ...
  void _startVolumeAdjust(
      LogicalKeyboardKey key, double delta, BeatsMusicPlayer player) {
  ...
  void _togglePlayPause(BeatsMusicPlayer player) {
  ...
  double _changeVolume(BeatsMusicPlayer player, double delta) {
  ...
  (bool, double) _toggleMute(BeatsMusicPlayer player) {
    final currentVolume = player.engine.volume;
    if (currentVolume > 0) {
  ...
  LoopMode _cycleLoopMode(BeatsMusicPlayer player) {
  ...
  Future<void> _toggleLike(BeatsMusicPlayer player) async {
