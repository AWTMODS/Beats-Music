...
/// The [BeatsMusicPlayer] reads [currentTrack] after calling navigation
...
class QueueManager {
  ...
  /// [BeatsMusicPlayer] checks this to skip the persistence listener
  ...
  ///
  /// Called from [BeatsMusicPlayer] via a throttled listener on
