...
/// Resolves shared YouTube URLs into playable [Track] objects by delegating to
/// loaded content-resolver plugins, ranked by user-configured priority and
/// host-site affinity.
class SharedUrlResolverService {
  ...
  /// Ranks loaded content-resolver plugins for [url]:
  /// plugins that explicitly claim the URL host are sorted before generic
  /// fallbacks. Within each group plugins are ordered by user priority list.
  static Future<List<PluginInfo>> _rankContentResolversForUrl(
    ...
    // with older/community plugins that haven't filled host_site yet.
