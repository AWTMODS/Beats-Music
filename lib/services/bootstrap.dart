...
import 'package:beats_music/services/local_music_service.dart';
...
import 'package:beats_music/src/rust/frb_generated.dart';
...
Future<void> bootstrapApp() async {
  ...
  try {
    ...
    log('Rust library initialization failed (non-fatal)',
