...
import 'package:beats_music/screens/widgets/smart_replace_dialog.dart';
...
import 'package:beats_music/services/song_metadata_refresh_service.dart';
...
class _TrackOptionsBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final player = parentContext.read<BeatsPlayerCubit>().BeatsPlayer;
