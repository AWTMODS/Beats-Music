...
class _PluginBootstrapOverlayState extends State<PluginBootstrapOverlay>
  ...
  void _onSkip() {
    final settingsDao = SettingsDAO(DBProvider.db);
    settingsDao.putSettingBool(SettingKeys.repositoriesBootstrapped, true);
    widget.onComplete();
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            l10n?.pluginBootstrapTitle ?? 'Setting up Beats',
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Beats needs an internet connection once to detect your country and set up the plugin engine.',
              textAlign: TextAlign.center,
              style: TextStyle(
