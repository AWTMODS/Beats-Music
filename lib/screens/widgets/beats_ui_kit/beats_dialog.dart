...
///   actions: [
///     BeatsDialogAction.text('Cancel'),
///     BeatsDialogAction.filled('Delete', isDestructive: true, onPressed: () {}),
///   ],
/// );
/// ```
class BeatsDialogAction {
  final String label;
  final VoidCallback? onPressed;
  final bool isDestructive;
  final bool isFilled;

  const BeatsDialogAction.text(
    this.label, {
    this.onPressed,
    this.isDestructive = false,
  }) : isFilled = false;

  const BeatsDialogAction.filled(
    this.label, {
    this.onPressed,
    this.isDestructive = false,
  }) : isFilled = true;
...
/// Display the standard Beats dialog.
Future<T?> showBeatsDialog<T>({
  required BuildContext context,
  required String title,
  String? subtitle,
  Widget? body,
  IconData? icon,
  List<BeatsDialogAction>? actions,
...
class BeatsDialogSurface extends StatelessWidget {
  final String title;
  final String? subtitle;
  final Widget? body;
  final IconData? icon;
  final List<BeatsDialogAction>? actions;

  const BeatsDialogSurface({
    super.key,
    required this.title,
    this.subtitle,
    this.body,
  ...
  Widget _buildAction(BuildContext context, BeatsDialogAction action) {
...
/// A Beats-styled list-tile for use inside dialog bodies.
///
...
class BeatsDialogTile extends StatelessWidget {
  final String title;
  final String? subtitle;
...
class BeatsDialogBadge extends StatelessWidget {
  final String label;
  final Color? color;

  const BeatsDialogBadge(this.label, {super.key, this.color});
