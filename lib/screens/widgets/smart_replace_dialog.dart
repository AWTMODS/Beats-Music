...
class _SmartReplaceDialogState extends State<_SmartReplaceDialog> {
  ...
  void initState() {
    ...
    _service = SmartTrackReplacementService.create(
      context.read<BeatsPlayerCubit>().BeatsPlayer.pluginService,
    );
                    ...
                    children: [
                      if (index == 0)
                        Padding(
                          ...
                          child: BeatsDialogBadge(l10n.smartReplaceBestMatch),
                        ),
                      isApplying
                          ? const SizedBox(
                              width: 20,
