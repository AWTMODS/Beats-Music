...
class _LegacyMigrationOverlayState extends State<LegacyMigrationOverlay>
  ...
  static const _successAccent = Color(0xFFFF2A5F); // Beats Pink/Red
    ...
    return ValueListenableBuilder<_Phase>(
      ...
      builder: (context, phase, _) {
        final title = switch (phase) {
          _Phase.running => 'Upgrading Beats',
          _Phase.success => 'Welcome to Beats 3.0',
  ...
  Widget _buildActionButton() {
    ...
    return Container(
      ...
      child: FilledButton(
        ...
        child: Text(
          isErr ? 'Retry Migration' : 'Enter Beats',
