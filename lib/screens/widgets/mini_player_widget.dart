  ...
  Widget build(BuildContext context) {
    ...
    if (state.isCompleted) {
      return _ControlButton(
        ...
        onPressed: () {
          HapticFeedback.mediumImpact();
          context.read<BeatsPlayerCubit>().BeatsPlayer.rewind();
        },
      );
    }
    ...
    return GestureDetector(
      onTap: () {
        HapticFeedback.lightImpact();
        state.isPlaying
            ? context.read<BeatsPlayerCubit>().BeatsPlayer.pause()
            : context.read<BeatsPlayerCubit>().BeatsPlayer.play();
      },
      child: Container(
        width: 42,
        height: 42,
  ...
  Widget build(BuildContext context) {
    return Positioned(
      ...
      child: StreamBuilder<ProgressBarStreams>(
        stream: context.watch<BeatsPlayerCubit>().progressStreams,
