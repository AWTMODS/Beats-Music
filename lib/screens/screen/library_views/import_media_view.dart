...
class _ImportMediaFromPlatformsViewState
            ...
            builder: (context, pluginState) {
              ...
              return ListView(
                ...
                children: [
                  ...
                  _ImportFromBtn(
                    btnName: AppLocalizations.of(context)!.importBeatsFiles,
                    btnIcon: MingCute.file_import_fill,
                    onClickFunc: () => _importBeatsFile(context),
                  ),
  ...
  // ─── Import Beats JSON/BLM files ────────────────────────────────────────

  void _importBeatsFile(BuildContext context) {
    showDialog(
      context: context,
