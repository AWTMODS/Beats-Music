...
import 'package:beats_music/plugins/blocs/chart/chart_bloc.dart';
import 'package:beats_music/plugins/blocs/chart/chart_event.dart';
import 'package:beats_music/plugins/blocs/chart/chart_state.dart';
...
import 'package:beats_music/screens/screen/chart/chart_widget.dart';
                    ...
                    return CarouselSlider.builder(
                      ...
                      options: CarouselOptions(
                        height: ResponsiveBreakpoints.of(context).isMobile ||
                            ...
                            ? MediaQuery.of(context).size.height * 0.22 // Reduced height to look like a square card
                            : 200,
                        viewportFraction:
                            ResponsiveBreakpoints.of(context).isMobile
                                ? 0.42 // Show more than one card to match the reference image scrolling
                                : ResponsiveBreakpoints.of(context).isTablet
                                    ? 0.30
                                    : 0.25,
                        autoPlay: autoPlay,
                        ...
                        padEnds: false, // Don't pad ends, align to the left side like normal lists
                        enableInfiniteScroll: false,
                        enlargeCenterPage: false, // Stop enlarging the center card so it looks like a flat scrolling list
                      ),
                    );
                  },
                ),
