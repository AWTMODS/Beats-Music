...
import 'package:beats_music/screens/screen/home_views/plugin_repository_view.dart';
import 'package:beats_music/plugins/blocs/repository/plugin_repository_cubit.dart';
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        if (plugin.pluginPath.startsWith('simulated://')) ...[
                          const SizedBox(width: 8),
                          Container(
                            ...
                            child: const Text(
                              'SIMULATED',
                              style: TextStyle(color: Colors.blue, fontSize: 8, fontWeight: FontWeight.w900, letterSpacing: 0.5),
                            ),
                          ),
                        ],
...
class _PluginDetailSheet extends StatelessWidget {
  ...
  void _confirmDelete(
    ...
    showBeatsDialog(
      ...
      actions: [
        BeatsDialogAction.text(l10n.pluginManagerCancel),
        BeatsDialogAction.filled(
