          ...
          return ListView(
            children: [
              ...
              ExpansionTile(
                ...
                subtitle: Text(
                  "Manage the trending sections you want to see in the home screen.",
                  style: TextStyle(
                          color: Default_Theme.primaryColor1.withOpacity(0.5),
                          fontSize: 12)
                      .merge(Default_Theme.secondoryTextStyleMedium),
                ...
                children: [
                  SwitchListTile(
                      value: state.showMalayalamTrending,
                      title: Text(
                        "Malayalam Trending",
                        style: const TextStyle(
                                color: Default_Theme.primaryColor1,
                      ...
                      onChanged: (b) {
                        context
                            .read<SettingsCubit>()
                            .setShowMalayalamTrending(b);
                      }),
                  SwitchListTile(
                      value: state.showHindiTrending,
                      title: Text(
                        "Hindi Trending",
                        style: const TextStyle(
                                color: Default_Theme.primaryColor1,
