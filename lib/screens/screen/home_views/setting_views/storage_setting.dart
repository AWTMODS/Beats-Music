          ...
          return ListView(
            children: [
                ...
                onTap: () async {
                  ...
                  if (confirm == true && context.mounted) {
                    ...
                    try {
                      ...
                      SnackbarService.showMessage('Cache cleared successfully!');
                    } catch (e) {
                      SnackbarService.showMessage('Error clearing cache: $e');
                    }
                  }
                },
              ),
              ...
              SettingTile(
                ...
                onTap: () {
                  BeatsMusicDBService.createBackUp().then((value) {
                    if (value != null) {
                      ...
                      if (Platform.isAndroid) {
                        ...
                        try {
                          ...
                          SharePlus.instance
                            ...
                            ShareParams(
                              files: [file],
                              text: 'Beats backup file',
                              subject: 'Beats Backup',
                            ),
                          )
                              .catchError((e) {
              ...
              SettingTile(
                ...
                onTap: () async {
                  final proceed = await showDialog<bool>(
                    ...
                    builder: (ctx) {
                      return AlertDialog(
                        ...
                        content: Text(
                          "Are you sure you want to reset the Beats app? This will delete all your data, including tunes you listened to, and reset the app to its default state. This action cannot be undone.",
                          style: Default_Theme.secondoryTextStyle.merge(
                            const TextStyle(color: Colors.white, fontSize: 14),
                          ),
                        ),
                  ...
                  if (proceed == true) {
                    ...
                    await BeatsMusicDBService.resetDB();
                    SnackbarService.showMessage(
...
Future<void> _onRestoreTap(BuildContext context) async {
  try {
    ...
    try {
      ...
      restoreResult = await BeatsMusicDBService.restoreDB(
        savedPath,
      ...
      if (progressDialogContext != null) {
        try {
          ...
          log("Failed to pop progress dialog: $e", name: "BeatsDBService");
        }
      } else {
...
Future<String?> _savePickedFileToInternalDir(PlatformFile picked) async {
  try {
    ...
    final filename =
        'beats_restore_${DateTime.now().millisecondsSinceEpoch}_$safeName';
