                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      if (snapshot
                                                                        ...
                                                                        return StreamBuilder<
                                                                                PlayerState>(
                                                                            stream:
                                                                                context.read<BeatsPlayerCubit>().beatsMusicPlayer.audioPlayer.playerStateStream,
                                                                            builder: (context, snapshot2) {
                                                                              if (snapshot2.hasData && (snapshot2.data?.playing ?? false)) {
                                                                                return PlayPauseButton(
                                                                                  onPause: () => context.read<BeatsPlayerCubit>().beatsMusicPlayer.pause(),
                                                                                  onPlay: () => context.read<BeatsPlayerCubit>().beatsMusicPlayer.play(),
                                                                                  isPlaying: true,
                                                                                  size: 45,
                                                                                );
                                                                              } else {
                                                                        ...
                                                                        return PlayPauseButton(
                                                                          ...
                                                                          onPlay:
                                                                              () {
                                                                            context.read<BeatsPlayerCubit>().beatsMusicPlayer.loadPlaylist(MediaPlaylist(
                                                                                mediaItems: mediaitems,
                                                                                playlistName: "${widget.title} - Youtube"));
                                                                            context.read<BeatsPlayerCubit>().beatsMusicPlayer.play();
                                                                          },
                                                                          size:
                                                                              45,
                                                                        );
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      await Future.forEach(
                                                                          mediaitems,
                                                                          (element) {
                                                                        BeatsMusicDBService.addMediaItem(
