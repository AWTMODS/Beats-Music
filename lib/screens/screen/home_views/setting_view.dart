...
import 'package:beats_music/screens/screen/home_views/setting_views/local_music_setting.dart';
import 'package:beats_music/screens/screen/home_views/setting_views/plugin_defaults_setting.dart';
      ...
      body: Center(
        child: ConstrainedBox(
          ...
          child: ListView(
            ...
            children: [
              // ── Group 1: Playback & Customization ──
              _SettingsSection(
                children: [
                  _SettingsTile(
              ...
              // ── Group 2: Connectivity & Media ──
              _SettingsSection(
                children: [
                  _SettingsTile(
                    title: 'Cloud Sync',
                    subtitle: 'Sync your data with Google Cloud',
                    icon: MingCute.refresh_2_fill,
                    iconColor: Default_Theme.accentColor2,
                    onTap: () => _navigate(context, const CloudSyncSettings()),
                  ),
                  _SettingsTile(
