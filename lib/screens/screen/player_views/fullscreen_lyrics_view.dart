...
import 'package:beats_music/screens/screen/player_views/lyrics_menu.dart';
...
class _FullscreenLyricsViewState extends State<FullscreenLyricsView>
      ...
      body: GestureDetector(
        ...
        child: Stack(
          children: [
            ...
            _buildBackground(beatsPlayerCubit),
              ...
              child: Column(
                children: [
                  ...
                  FadeTransition(
                    ...
                    child: _buildTopBar(beatsPlayerCubit),
                  ),
                  ...
                  FadeTransition(
                    opacity: _fadeController,
                    child: _buildBottomControls(beatsPlayerCubit),
                  ),
                ],
              ),
            ),
  ...
  Widget _buildBackground(BeatsPlayerCubit beatsPlayerCubit) {
  ...
  Widget _buildTopBar(BeatsPlayerCubit beatsPlayerCubit) {
    return Container(
  ...
  Widget _buildBottomControls(BeatsPlayerCubit beatsPlayerCubit) {
...
class _FullscreenSyncedLyricsState extends State<FullscreenSyncedLyrics> {
  ...
  void _setupPositionListener() {
    final beatsPlayerCubit = context.read<BeatsPlayerCubit>();
    _positionSubscription = beatsPlayerCubit
  ...
  void _onLyricTap(int index) {
    ...
    if (lyric != null) {
      context.read<BeatsPlayerCubit>().beatsMusicPlayer.seek(lyric.start);
    }
  }
