...
class Default_Theme {
  ...
  // Colors
  static const themeColor = Color(0xFF000000); // Pure black background (Spotify-style)
  static const cardColor = Color(0xFF1A1A1A); // Dark gray cards
  static const cardColorLight = Color(0xFF282828); // Lighter card variant
  static const primaryColor1 = Color(0xFFFFFFFF); // Pure white for primary text
  static const primaryColor2 = Color(0xFFB3B3B3); // Light gray for secondary text
  static const spotifyGreen = Color(0xFF1DB954); // Spotify green
  static const accentColor1 = Color(0xFF1DB954); // Spotify green
  static const accentColor1light = Color(0xFF1ED760); // Lighter Spotify green
  static const accentColor2 = Color(0xFF1DB954); // Spotify green
