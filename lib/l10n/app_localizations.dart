...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'I want Beats to keep improving.'**
  ...
  /// No description provided for @importBeatsFiles.
  ///
  /// In en, this message translates to:
  /// **'Import Beats Files'**
  String get importBeatsFiles;
