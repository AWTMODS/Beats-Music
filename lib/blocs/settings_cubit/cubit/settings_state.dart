...
class SettingsState extends Equatable {
  ...
  bool autoSaveLyrics;
  bool autoPlay;
  bool aggressivePreload;
  bool useSpotifySearch;
  ...
  SettingsState({
    ...
    required this.aggressivePreload,
    required this.useSpotifySearch,
    required this.enableCrossfade,
  ...
  SettingsState copyWith({
    ...
    return SettingsState(
      ...
      aggressivePreload: aggressivePreload ?? this.aggressivePreload,
      useSpotifySearch: useSpotifySearch ?? this.useSpotifySearch,
