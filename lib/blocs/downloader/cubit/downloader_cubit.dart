...
import 'package:beats_music/services/download/rust_download_service.dart';
import 'package:beats_music/src/rust/api/downloader/types.dart';
import 'package:beats_music/utils/download_types.dart';
...
class DownloaderCubit extends Cubit<DownloaderState> {
  ...
  Future<void> _initializeDownloadService() async {
    ...
    await _downloadService.initialize(
      ...
      tempDir: path.join(tempDirectory.path, 'Beats_downloads'),
    );
