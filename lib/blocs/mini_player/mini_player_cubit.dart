...
class MiniPlayerCubit extends Cubit<MiniPlayerState> {
  final BeatsPlayerCubit _playerCubit;
  StreamSubscription? _sub;

  MiniPlayerCubit({required BeatsPlayerCubit playerCubit})
  ...
  void _listen() {
    _sub = Rx.combineLatest4<MediaItem?, EngineState, bool, bool,
      ...
      _playerCubit.BeatsPlayer.mediaItem.startWith(_playerCubit.BeatsPlayer.mediaItem.valueOrNull),
      Rx.defer(() => _playerCubit.BeatsPlayer.engine.stateStream,
          reusable: true).startWith(_playerCubit.BeatsPlayer.engine.state),
      Rx.defer(() => _playerCubit.BeatsPlayer.engine.playingStream,
          reusable: true).startWith(_playerCubit.BeatsPlayer.engine.playing),
      _playerCubit.BeatsPlayer.isResolving.startWith(_playerCubit.BeatsPlayer.isResolving.value),
