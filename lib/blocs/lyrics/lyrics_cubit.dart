...
import 'package:beats_music/core/models/exported.dart' hide Lyrics;
import 'package:beats_music/core/models/lyrics_models.dart';
...
import 'package:beats_music/src/rust/api/plugin/models.dart' as plugin_models;
...
class LyricsCubit extends Cubit<LyricsState> {
  ...
  LyricsCubit(
    ...
    _mediaItemSubscription =
        playerCubit.BeatsPlayer.mediaItem.stream.listen((item) {
      if (item != null) {
